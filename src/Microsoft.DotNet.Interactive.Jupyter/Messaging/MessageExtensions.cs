...
public static class MessageExtensions
{
    ...
    public static T DeserializeFromJsonString<T>(string source)
    {
        ...
        {
            ret = JsonSerializer.Deserialize<T>(source, Polyglossy.Interactive.Connection.Serializer.JsonSerializerOptions);
        }
        return ret;
    }
    ...
    {
        var header = JsonSerializer.Deserialize<Header>(headerJson, options ?? Polyglossy.Interactive.Connection.Serializer.JsonSerializerOptions);
