...
export class TestPolyglossyInteractiveChannel implements PolyglossyInteractiveChannel {
...
export const TestDotnetInteractiveChannel = TestPolyglossyInteractiveChannel;
