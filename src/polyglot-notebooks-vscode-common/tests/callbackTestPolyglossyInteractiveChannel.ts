...
export class CallbackTestPolyglossyInteractiveChannel implements PolyglossyInteractiveChannel {
...
export const CallbackTestTestDotnetInteractiveChannel = CallbackTestPolyglossyInteractiveChannel;
